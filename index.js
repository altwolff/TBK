...
async function main() {
    ...
    const sampleBooks = [
        {
            ...
            publicationYear: 1990, totalCopies: 3, borrowedCopies: 0, genre: 'Fantasy'
        },
        {
            title: '1984', author: 'Orwell', isbn: '1234567890124',
            publicationYear: 1949, totalCopies: 5, borrowedCopies: 0, genre: 'Dystopia'
        },
    ];
    ...
    console.log('Ostatnie zdarzenia:', history.map(e => e.eventName));
